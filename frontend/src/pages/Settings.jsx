      ...
      >
        ...
        <div className="md:max-w-2xl md:mx-auto">
          ...
          <motion.div
            ...
            className="bg-[#E7F0EF] rounded-3xl p-6 mb-6 flex flex-col items-center md:flex-row md:items-center md:gap-5"
          >
            <div className="relative mb-3 md:mb-0 shrink-0">
              {profile.avatar ? (
                <img src={profile.avatar} alt={profile.name} className="h-20 w-20 rounded-full object-cover border-2 border-white shadow-md" />
              ) : (
            ...
            <div className="flex-1 text-center md:text-left mb-3 md:mb-0">
              ...
              <p className="text-sm text-text-secondary mt-0.5">{profile.plan} • Since {profile.memberSince}</p>
            </div>
          ...
          <motion.div
            ...
            animate="visible"
          >
            <motion.h3 variants={staggerItem} className="text-lg font-bold text-text-title mb-4 md:mb-5">
              Preferences
            </motion.h3>

            <motion.div
              variants={staggerItem}
              className="border-[0.3px] border-border rounded-3xl px-4 py-2 md:py-4 md:border-0 md:rounded-none"
            >
              <PreferenceRow
                label="Notifications"
                value="Managed"
              ...
              <motion.button
                ...
                className="flex w-full items-center gap-4 py-5 md:py-6 px-1 rounded-xl transition-colors"
              >
