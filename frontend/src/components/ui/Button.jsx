...
export default function Button({
  ...
  const base =
    'group rounded-xl p-4 text-sm font-bold cursor-pointer flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2'
  ...
  return (
    <motion.button
      ...
      className={`${base} ${variants[variant]} ${fullWidth ? 'w-full' : ''} transition-colors ${className}`}
    >
      {loading && (
        <svg
