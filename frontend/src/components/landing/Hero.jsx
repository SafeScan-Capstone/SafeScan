...
import { fadeUp, staggerContainer, staggerItem, EASE_SPRING } from '../../animations/variants'
...
export default function Hero() {
  ...
  return (
    ...
    >
      <motion.div variants={staggerItem} className="bg-[#E7F0EF] rounded-full px-5 py-2.5 mb-6 w-full h-[56px] lg:w-auto lg:h-auto lg:py-3 lg:px-6">
          ...
          <div className="flex -space-x-2">
            {['1', '3', '5', '8'].map((id, i) => (
              <motion.img
                ...
                transition={{ delay: 0.5 + i * 0.07, duration: 0.35, ease: EASE_SPRING }}
