    ...
    <div style={{ display:'flex', flexDirection:'column', height:'100%', background:'#FEFEFE', overflowY:'auto' }}>
      <div style={{ flex:1, padding:'56px 24px 32px' }}>
        ...
        <p style={{ fontSize:15, color:'#808080', margin:'0 0 36px' }}>
          Please Sign up to continue your journey
        </p>

        {/* Full Name */}
        <label style={{ fontSize:14, fontWeight:700, color:'#1A1A1A', display:'block', marginBottom:8 }}>Full Name</label>
        <input
          type="text"
          value={name}
        ...
        <p style={{ fontSize:12, color:'#808080', margin:'0 0 20px' }}>Must be at least 8 characters</p>

        {/* Confirm Password */}
        <label style={{ fontSize:14, fontWeight:700, color:'#1A1A1A', display:'block', marginBottom:8 }}>Confirm Password</label>
        ...
        <label style={{ display:'flex', alignItems:'center', gap:10, marginBottom:28, cursor:'pointer' }}>
          <div
            ...
            style={{
              ...
              border:`2px solid ${agreed ? '#0D645D' : '#D2D5DB'}`,
              background: agreed ? '#0D645D' : 'white',
          ...
          <span style={{ fontSize:14, color:'#484848' }}>
            Agree with{' '}
            <span style={{ color:'#0D645D', fontWeight:600 }}>Terms &amp; Conditions</span>
          </span>
        </label>
        ...
        <button
          ...
          style={{ width:'100%', height:52, background:'#0D645D', color:'white', fontSize:16, fontWeight:700, border:'none', borderRadius:14, cursor:'pointer', marginBottom:12 }}
        >
          Sign Up
        </button>
        ...
        <button
          onClick={() => navigate('/home')}
          style={{ width:'100%', height:52, background:'white', color:'#0D645D', fontSize:16, fontWeight:700, border:'1.5px solid #0D645D', borderRadius:14, cursor:'pointer', marginBottom:28 }}
        >
          Continue as a Guest
        </button>
        ...
        <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:24 }}>
          ...
          <span style={{ fontSize:13, color:'#808080', whiteSpace:'nowrap' }}>or SignUp with</span>
          <div style={{ flex:1, height:1, background:'#E7F0EF' }}/>
        </div>
        ...
        <p style={{ textAlign:'center', fontSize:14, color:'#808080', margin:0 }}>
          ...
          <button onClick={() => navigate('/signin')} style={{ background:'none', border:'none', cursor:'pointer', fontSize:14, fontWeight:700, color:'#0D645D', padding:0 }}>
            Sign In
          </button>
        </p>
      </div>
